...
)  # (cadd_rest_api/config/settings/base.py - 3 = cadd_rest_api/)
APPS_DIR = ROOT_DIR.path("cadd_rest_api")
...
MIGRATION_MODULES = {"sites": "cadd_rest_api.contrib.sites.migrations"}
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "cadd_rest_api.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "cadd_rest_api.users.adapters.SocialAccountAdapter"
...
CADD_TIMEOUT = env.int("CADD_TIMEOUT", 30)
...
CADD_SH = env.str("CADD_SH", "CADD.sh")
